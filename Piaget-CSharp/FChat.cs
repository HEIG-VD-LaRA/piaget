...
namespace Piaget_CSharp
{
    public partial class FChat : Form
    {
        ...
        byte[] buffer;
        int txtMessageoffset;
        int ListMessagesoffset;
        public FChat()
        {
            InitializeComponent();
            StartPosition = FormStartPosition.CenterScreen;
            txtMessageoffset = this.Width - txtMessage.Width;
            ListMessagesoffset = this.Width - ListMessages.Width;
        }
        ...
        private void FChat_resize(object sender, EventArgs e)
        {
            txtMessage.Width = this.Width - txtMessageoffset;
            ListMessages.Width = this.Width - ListMessagesoffset;
        }
